...
System software engineer with 5+ years of experience at Huawei, focused on CPU functional simulation, microarchitectural design space exploration, and compiler optimisations. Skilled in C++, LLVM, and JIT compilation. Proven ability to lead research projects from prototype to product integration. Passionate about teaching and mentoring. Looking for opportunities in compilers, emulation, or high-performance computing.

System software engineer with 5+ years at Huawei. I led the development of a CPU functional simulator from early prototype to successful integration into a product, working in a team of two. My technical scope spans simulation internals, JIT-based acceleration, microarchitectural exploration, and compiler tooling. Strong in C++, LLVM, and low‑level programming (AArch64 assembly). Co-created the “CPU & OS Simulation” university course. Looking for roles in emulation, simulation, or high‑performance systems engineering.
}
...
\section{Experience}
    ...
    %
    %
    \datedexperience{Huawei}{Jul 2021 -- Present / Moscow, Russia}
    \explanationdetail{
      \coloredbullet\
