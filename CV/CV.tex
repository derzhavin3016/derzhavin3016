...
\section{Experience}
    ...
    \explanationdetail{\coloredbullet\
    Led a project related to functional simulation.
    Participated in cross-project activities.
    }
    \explanationdetail{\coloredbullet\
    ...
    \explanationdetail{\coloredbullet\
    Implemented tool which finds loops in program's CFG using Boost Graph. Conducted research on dynamic cycles classification, estimate potential performance improve from enhancing loop termination prediction using ISA hint
    }
    % \explanationdetail{\coloredbullet\
    % }
    %
...
\section{Projects}
  ...
  \datedexperience{
    ...
    {Triangles}}{Feb 2022 -- May 2022}
  \explanation{Educational project}
  \explanationdetail{\coloredbullet\
    Program to check intersection of large amount of triangles
  }
  \datedexperience{
    \href{https://github.com/106-inc/sim2022}
    {Sim2022}}{Oct 2022 -- Jan 2023}
  \explanation{Educational project}
  \explanationdetail{\coloredbullet\
    Functional simulator of RISC-V ISA w/ by-BasicBlock execution, code caching \& TLB.

    \coloredbullet\
    Implemented autogeneration of decoder from ISA-description.
  }
  \datedexperience{
...
\section{Extra}
    ...
    %
    \newcommand{\extratwo}{%
      Resolute, hardworking, detail-oriented
    }
    %
